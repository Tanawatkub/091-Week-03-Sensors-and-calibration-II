...
| สภาพแสง  | ความต้านทาน   | ความต้านทานที่วัดได้  | แรงดันเอาต์พุต (โวลต์) |
| -------- | ------------- |---------  | ---------------------- |
| มืดสนิท  | 200 kΩ – 2 MΩ |       383.35 kΩ      |     3.22 V        |
| ห้องปกติ | 10 kΩ – 50 kΩ |       4.957 kΩ       |     1.09 V        |
| ใต้โคมไฟ | 2 kΩ – 10 kΩ  |      162.3 Ω        |     0.05 V        |
| กลางแจ้ง | 200 Ω – 2 kΩ  |        -            |       -           |
...
| ----------- | ---- | ---------- | ----------- |
| ใต้โต๊ะ     | 600  | 10         | 38          |
| ห้องเรียน   | 1500 | 160        | 175         |
| หน้าต่าง    | 2800 | 2000        | 520         |
...
1. ทำไมต้องใช้ Voltage Divider ในการอ่าน LDR?
   - เพราะ LDR เปลี่ยนค่าความต้านทานตามความเข้มของแสง แต่ไมโครคอนโทรลเลอร์ไม่สามารถวัดค่าความต้านทานได้โดยตรง จึงต้องใช้วงจร Voltage Divider เพื่อแปลงค่าความต้านทานของ LDR ให้เป็นแรงดันไฟฟ้า ซึ่ง ADC สามารถอ่านและนำไปประมวลผลได้
2. ทำไมต้องเก็บข้อมูลหลายจุดก่อนทำ Calibration?
   - เพื่อให้ได้ข้อมูลที่ครอบคลุมช่วงการวัดทั้งหมด ทำให้สามารถสร้างสมการ Calibration ที่แม่นยำ ลดความคลาดเคลื่อน และสะท้อนความสัมพันธ์ที่แท้จริงระหว่างค่า ADC กับค่า Lux
3. ถ้า Noise มากกว่าสัญญาณจริง จะเกิดอะไรขึ้น?
   - ค่า ADC จะไม่นิ่งและแกว่งมาก ทำให้ค่าที่วัดได้ไม่ตรงกับสภาพแสงจริง ส่งผลให้การคำนวณค่า Lux มีความผิดพลาดและความแม่นยำของระบบลดลง
4. ทำไมการวางตำแหน่งเซนเซอร์จึงสำคัญต่อ Signal Integrity?
   - เพราะตำแหน่งของเซนเซอร์มีผลต่อปริมาณแสงที่ได้รับ รวมถึงการรบกวนจากแสงสะท้อน เงา และสัญญาณรบกวนจากอุปกรณ์อื่น หากติดตั้งไม่เหมาะสม ค่าที่วัดได้จะคลาดเคลื่อนและไม่น่าเชื่อถือ
5. ถ้า ADC มี Resolution ต่ำ จะส่งผลอย่างไรต่อความแม่นยำ?
    - ADC ที่มี Resolution ต่ำจะแบ่งระดับแรงดันได้หยาบกว่า ทำให้การเปลี่ยนแปลงของแสงเล็กน้อยไม่สามารถตรวจจับได้ ส่งผลให้ค่าที่อ่านมีความละเอียดและความแม่นยำลดลง รวมถึงเกิดความคลาดเคลื่อนในการวัดมากขึ้น
...
| --- | -------------------------------------------------------------- | -------------------- | ------ |
| 1.1 | อธิบายหลักการทำงานของ LDR ได้ถูกต้อง                           |            5          |    อธิบายหลักการทำงานของ LDR ได้ถูกต้องและเชื่อมโยงกับการเปลี่ยนแปลงของความต้านทานตามความเข้มแสงได้ชัดเจน    |
| 1.2 | อธิบายการทำงานภายใน LDR (โฟตอน → อิเล็กตรอน → conduction band) |           4           |    อธิบายกระบวนการโฟตอนกระตุ้นอิเล็กตรอนได้ถูกต้อง แต่รายละเอียดของ Conduction Band และการเกิด Hole ยังไม่ครบถ้วน    |
| 1.3 | เข้าใจว่าความสัมพันธ์ R vs Lux ไม่เป็นเส้นตรง                  |             5         |    เข้าใจว่าความสัมพันธ์ระหว่างความต้านทานกับค่า Lux เป็นแบบไม่เชิงเส้น และอธิบายได้ถูกต้อง    |
| 1.4 | เข้าใจเหตุผลที่ต้องใช้ Voltage Divider                         |            4          |    เข้าใจเหตุผลของการใช้ Voltage Divider แต่ยังอธิบายหลักการแปลงค่าความต้านทานเป็นแรงดันได้ไม่ละเอียดมาก    |

### **ส่วนที่ 10.2 — การต่อวงจรและอ่านค่า ADC (20 คะแนน)**

| ข้อ | รายการ                              | คะแนน<br>(0–5 คะแนน) | เหตุผล |
| --- | ----------------------------------- | -------------------- | ------ |
| 2.1 | ต่อวงจร Voltage Divider ได้ถูกต้อง  |            4            |    ต่อวงจรได้ถูกต้อง แต่ยังมีข้อสังเกตเกี่ยวกับการตรวจสอบการต่อสายหรือการอธิบายจุดวัดแรงดัน    |
| 2.2 | เลือกค่า R คงที่เหมาะสม (เช่น 10kΩ) |             5           |     เลือกใช้ตัวต้านทาน 10 kΩ ได้เหมาะสมกับช่วงการทำงานของ LDR   |
| 2.3 | เขียนโปรแกรมอ่านค่า ADC ได้ถูกต้อง  |              5          |    เขียนโปรแกรมอ่านค่า ADC ได้ถูกต้องและแสดงผลได้ครบถ้วน    |
| 2.4 | ใช้ ESP‑IDF ADC + Calibration ได้   |          5              |   ใช้ ESP-IDF ADC Calibration ได้ถูกต้อง ช่วยให้ค่าที่อ่านมีความแม่นยำมากขึ้น     |

### **ส่วนที่ 10.3 — การเก็บข้อมูลจริง (20 คะแนน)**

| ข้อ | รายการ                             | คะแนน<br>(0–5 คะแนน) | เหตุผล |
| --- | ---------------------------------- | -------------------- | ------ |
| 3.1 | เก็บข้อมูล ADC อย่างน้อย 5–7 จุด   |           5           |    เก็บข้อมูลหลายระดับแสงได้เพียงพอสำหรับการวิเคราะห์    |
| 3.2 | วัดค่า Lux จากมือถือได้ถูกต้อง     |             5         |    วัดค่า Lux จากแอปบนมือถือได้ถูกต้องและสม่ำเสมอ    |
| 3.3 | จดข้อมูลเป็นตารางครบถ้วน           |          5            |    บันทึกข้อมูลเป็นตารางครบถ้วน อ่านง่าย    |
| 3.4 | ควบคุมสภาพแสงให้คงที่ระหว่างการวัด |           5           |     ควบคุมสภาพแสงระหว่างการทดลองได้ดี ทำให้ข้อมูลมีความน่าเชื่อถือ   |
...
| ข้อ | รายการ                                        | คะแนน<br>(0–5 คะแนน) | เหตุผล |
| --- | --------------------------------------------- | -------------------- | ------ |
| 4.1 | สร้างกราฟ Scatter ADC vs Lux ได้              |           5           |    สร้างกราฟ Scatter ได้ถูกต้องและแสดงข้อมูลครบ    |
| 4.2 | เลือก Trendline เหมาะสม (Linear / Polynomial) |          5            |    เลือก Trendline ได้เหมาะสมกับข้อมูล    |
| 4.3 | อ่านสมการจากกราฟได้ถูกต้อง                    |             5         |    อ่านสมการจากกราฟและนำไปใช้ได้ถูกต้อง    |
| 4.4 | นำสมการไปใช้ในโค้ดได้                         |           5           |    นำสมการไปประยุกต์ใช้ในโปรแกรมได้ถูกต้อง    |
| 4.5 | วิเคราะห์ว่า Linear หรือ Polynomial เหมาะกว่า |             4         |    วิเคราะห์ข้อดีข้อเสียของ Linear และ Polynomial ได้ แต่ยังอธิบายเหตุผลเชิงสถิติหรือค่าความคลาดเคลื่อนได้ไม่ลึกมาก    |
### **ส่วนที่ 10.5 — การทดสอบผลลัพธ์และวิเคราะห์ (15 คะแนน)**

| ข้อ | รายการ                   | คะแนน<br>(0–5 คะแนน) | เหตุผล |
| --- | ---------------------- | -------------------- | ------ |
| 5.1 | ทดสอบจุดแสงใหม่ที่ไม่ได้ใช้ตอนเก็บข้อมูล |            5          |    ทดสอบด้วยข้อมูลใหม่ที่ไม่ได้ใช้สร้างสมการได้ถูกต้อง    |
| 5.2 | เปรียบเทียบ Lux มือถือ vs Lux จากโค้ด    |       5               |    เปรียบเทียบค่าจากมือถือกับค่าที่คำนวณจากโค้ดได้ครบถ้วน    |
| 5.3 | วิเคราะห์ความคลาดเคลื่อนและสาเหตุได้     |         5             |   วิเคราะห์สาเหตุของความคลาดเคลื่อน เช่น ความแม่นยำของเซนเซอร์ สภาพแสง และความละเอียดของ ADC ได้เหมาะสม     |


.................................................................

###  **คะแนนรวมทั้งหมด:** `96 / 100`
...
1. จุดไหนในใบงานที่คิดว่ายากที่สุด?
   - การสร้างสมการ Calibration จากกราฟและเลือก Trendline ที่เหมาะสม เพราะต้องวิเคราะห์ข้อมูลหลายจุดและทำความเข้าใจความสัมพันธ์ที่ไม่เป็นเชิงเส้นระหว่างค่า ADC กับค่า Lux
    
2. ถ้าทำใบงานนี้อีกครั้ง จะปรับปรุงอะไร?
   - จะเก็บข้อมูลในช่วงความเข้มแสงให้มากขึ้น เพิ่มจำนวนจุดวัด และควบคุมสภาพแสงให้คงที่มากกว่าเดิม เพื่อให้สมการ Calibration มีความแม่นยำและลดความคลาดเคลื่อน
    
3. ส่วนไหนที่คิดว่าตนเองเข้าใจดีมาก?
   - การต่อวงจร Voltage Divider การอ่านค่า ADC ด้วย ESP-IDF และการอธิบายหลักการทำงานของ LDR รวมถึงการวิเคราะห์ผลการทดลองจากข้อมูลที่เก็บได้
